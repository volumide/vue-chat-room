    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
      ...
      <div class="" v-if="user">
        ...
        >
          ...
          <span class="mx-4 font-medium hidden sm:block"> Privacy</span>
        </a>

        <a
          class="flex items-center px-4 py-3 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700"
          href="#"
        >
          <svg
            class="w-5 h-5"
          ...
          <span class="mx-4 font-medium hidden sm:block">Logout</span>
        </a>
      </div>
      <!-- avartar -->
      <div class="flex items-center px-4 -mx-2 mt-11">
        <img
